        ...
        <div class="lg:col-span-1">
            ...
            <x-card>
                <h3 class="text-lg font-bold text-gray-900 mb-4">
                    <i class="fas fa-history"></i> Historial del Libro
                </h3>
                <div class="space-y-3">
                    @foreach($movimiento->libro->movimientos()->orderBy('created_at', 'desc')->take(10)->get() as $mov)
                        <div class="flex items-center justify-between p-3 {{ $mov->id === $movimiento->id ? 'bg-primary-50 border-2 border-primary-500' : 'bg-gray-50' }} rounded-lg">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="font-medium text-gray-900 text-sm">{{ $mov->getTipoLabel() }}</p>
